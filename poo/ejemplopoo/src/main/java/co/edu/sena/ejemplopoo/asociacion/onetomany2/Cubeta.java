package co.edu.sena.ejemplopoo.asociacion.onetomany2;

import co.edu.sena.ejemplopoo.asociacion.onetomany2.*;
...
public class Cubeta {
    ...
    public void agergarHuevo(Huevo huevo){
    ...
    public List<co.edu.sena.ejemplopoo.asociacion.onetomany2.Huevo> getHuevos() {
        return huevos;
    }

    public void setHuevos(List<co.edu.sena.ejemplopoo.asociacion.onetomany2.Huevo> huevos) {
        this.huevos = huevos;
    }
}
