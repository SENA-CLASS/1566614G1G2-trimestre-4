...
@NamedQueries({
    ...
    , @NamedQuery(name = "LogError.findByFecha", query = "SELECT l FROM LogError l WHERE l.fecha = :fecha")
    , @NamedQuery(name = "LogError.findByUsuario", query = "SELECT l FROM LogError l WHERE l.usuario = :usuario")})
public class LogError implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.odp.model.entities.LogError[ idLog=" + idLog + " ]";
    }
