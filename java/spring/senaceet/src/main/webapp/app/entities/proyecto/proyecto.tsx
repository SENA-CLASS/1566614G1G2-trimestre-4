    ...
    return (
      <div>
        <h2 id="proyecto-heading">
          <Translate contentKey="senaceetApp.proyecto.home.title">Proyectos</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="senaceetApp.proyecto.home.createLabel">Create new Proyecto</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('codigo')}>
                  <Translate contentKey="senaceetApp.proyecto.codigo">Codigo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('nombre')}>
                  <Translate contentKey="senaceetApp.proyecto.nombre">Nombre</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('estado')}>
                  <Translate contentKey="senaceetApp.proyecto.estado">Estado</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {proyectoList.map((proyecto, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`senaceetApp.Estado.${proyecto.estado}`} />
                  </td>
